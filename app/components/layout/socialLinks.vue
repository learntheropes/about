<template>
  <div class="flex items-center gap-5">
    ...
    <a href="https://www.linkedin.com/in/learntheropes/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
      class="transition" style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href="https://x.com/learntheropes21" target="_blank" rel="noopener noreferrer" aria-label="X" class="transition"
    ...
    <a href="mailto:g@lpy.lat" aria-label="Email" class="transition" style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href="https://signal.me/#eu/kg_2UmMbmHqulLuVtA27mwNQ3HcFg4HLJBC3xUA-5xKJTemoRG5G4L3ExrLLaNBn" target="_blank"
    ...
    <a href="https://t.me/learntheropes21" target="_blank" rel="noopener noreferrer" aria-label="Telegram"
      class="transition" style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href="https://instagram.com/learntheropes21" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
      class="transition" style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href="https://yakihonne.com/profile/nprofile1qqs26c7954qyy0x0g9tuku2snzmdg70zp3dvq4eykv7pu4eejz0q7mg39f73l"
      target="_blank" rel="noopener noreferrer" aria-label="Nostr" class="transition"
      style="color: var(--ui-text-dimmed)">
