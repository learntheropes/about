<template>
  <div class="flex items-center gap-5">
    ...
    <a href="https://www.linkedin.com/in/learnglpy/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
      class="transition" style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href="https://x.com/learnglpy" target="_blank" rel="noopener noreferrer" aria-label="X" class="transition"
    ...
    <a href="mailto:learn@g.lpy.lat" aria-label="Email" class="transition" style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href="https://signal.me/#eu/475wj_u_IHjpp48ds-GTudvMkdGqzs4yi5m_7KswB4I8F11y-KVM85zwBI2cHZkO" target="_blank"
    ...
    <a href="https://t.me/learnglpy" target="_blank" rel="noopener noreferrer" aria-label="Telegram" class="transition"
      style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <a href="https://instagram.com/learnglpy" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
      class="transition" style="color: var(--ui-text-dimmed)">
      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
