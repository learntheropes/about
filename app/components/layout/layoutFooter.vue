...
<template>
  <footer style="border-top: 1px solid var(--ui-border)">
    <div class="max-w-3xl mx-auto px-6 py-6 flex flex-col items-center gap-4">
      <div class="flex items-center gap-5">
        ...
        <a href="https://www.linkedin.com/in/learntheropes/" target="_blank" rel="noopener noreferrer"
          aria-label="LinkedIn" class="transition" style="color: var(--ui-text-dimmed)">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.79M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z" />
          </svg>
        </a>
        <a href="mailto:giovanni@lpy.lat" aria-label="Email" class="transition" style="color: var(--ui-text-dimmed)">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z" />
          </svg>
        </a>
        <a href="https://keys.openpgp.org/vks/v1/by-fingerprint/DA446D1A7A284885D7680F10322BB3D9118454CA"
          target="_blank" rel="noopener noreferrer" aria-label="PGP key" class="transition"
          style="color: var(--ui-text-dimmed)">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M12.65 10C11.83 7.67 9.61 6 7 6a6 6 0 0 0 0 12c2.61 0 4.83-1.67 5.65-4H17v4h4v-4h2v-4H12.65zM7 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" />
          </svg>
        </a>
        <a href="https://signal.me/#eu/cHcschK9E0Oz40ctBL9V6Em3bWzL4SUS1OCGUDraS81SEwyc8D5CBZcDB3uvI7Z-" target="_blank"
          rel="noopener noreferrer" aria-label="Signal" class="transition" style="color: var(--ui-text-dimmed)">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="https://t.me/giovannilpy" target="_blank" rel="noopener noreferrer" aria-label="Telegram"
          class="transition" style="color: var(--ui-text-dimmed)">
          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="https://njump.me/giovanni@learntheropes.xyz" target="_blank" rel="noopener noreferrer"
          aria-label="Nostr" class="transition" style="color: var(--ui-text-dimmed)">
          <svg class="w-5 h-5" viewBox="0 0 256 256" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="lightning:giovanni@learntheropes.xyz" aria-label="Lightning Network" class="transition"
          style="color: var(--ui-text-dimmed)">
      ...
      <div class="flex justify-center gap-3">
        <template v-for="loc in locales" :key="loc.code">
          <NuxtLink v-if="loc.code !== locale" :to="switchLocalePath(loc.code)"
            class="text-sm text-primary underline decoration-1 underline-offset-2 hover:opacity-75 transition">{{
              loc.name }}</NuxtLink>
