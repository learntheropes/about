...
I still have my old italian worldwide health insurance, now registered with the paraguyan residency from which I can get payouts to my Wise Belgian IBAN. 
I have a Unipol Unisalute Sanicard and a Unipol Infortuni Premium, one for illnesses and one for injuries, both valid worldwide 365 days a year.  
### Paraguayan insurance
I also have a national Paraguay insurance, provided by Banco Familiar, valid in some clinics including my usual one, that covers: any visit, any analysis and ospitalization (up to 4.000.000 Gs) that I pay 38.000 PYG/month.   -->

## What I do

### Peach Bitcoin
I work as the Head of Operations at [Peach Bitcoin](https://peachbitcoin.com), a p2p KYC-free privacy oriented Bitcoin exchange.

### P2PayTo
I'm the main developer at [P2PayTo](https://github.com/p2payto), a payment processor currently based on BTCPay Server and P2P kyc-free bitcoin exchanges where buyers pay with fiat local payment methods and the merchant receives bitcoin.

### Blockchange
I'm the founder of [Blockchange](https://blockchange.expert) a consultancy firm about multi rail payments infrastructure with settlement in bitcoin or stablecloins.

### BTCPay Server
I run a [BTCPay Server instance](https://learntheropes.xyz) where I never hold your funds and where open registrations are disabled due to spam, but feel free to contact me if you want an account. Here you have a wiki to set up your [on-chain](https://github.com/p2payto/p2pay-cloud/wiki/Setup-on%E2%80%90chain-wallet-with-Nunchuk) and [LN](https://github.com/p2payto/p2pay-cloud/wiki/Setup-Lightning-Network-wallet-with-Blink) wallets easily from a mobile. Please note that Blink is custodial so it's highly suggest to run your own node instead, if you have the skills.
